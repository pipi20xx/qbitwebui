...
export function MultiSelect({ options, selected, onChange, placeholder = '请选择...' }: MultiSelectProps) {
	...
	const displayText = selected.length === 0 ? placeholder : `已选择 ${selected.length} 项`
