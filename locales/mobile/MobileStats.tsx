	...
	return (
		<div className="space-y-3">
			...
			<div className="grid grid-cols-4 gap-2">
				{[
					{ label: '总计', value: counts.total, color: 'var(--text-primary)' },
					{ label: '下载中', value: counts.downloading, color: 'var(--accent)' },
					{ label: '做种中', value: counts.seeding, color: '#a6e3a1' },
					{ label: '已停止', value: counts.paused, color: 'var(--text-muted)' },
				].map((item) => (
					<div
						key={item.label}
